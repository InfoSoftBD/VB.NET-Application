...
Begin VB.Form frmFactory_Stm 
   BackColor       =   &H00004080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Godown Statement"
   ClientHeight    =   6600
   ClientLeft      =   -15
   ClientTop       =   375
   ClientWidth     =   7785
   Icon            =   "frmFactory_Stm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6600
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmFactory_Stm.frx":0442
         Left            =   2880
         List            =   "frmFactory_Stm.frx":0455
         TabIndex        =   7
         Top             =   750
         Width           =   2070
      End
      Begin VB.CommandButton Command5 
         Height          =   375
         Left            =   4800
         Picture         =   "frmFactory_Stm.frx":047D
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   2790
         Width           =   345
      ...
      Begin VB.CommandButton Command4 
         Height          =   375
         Left            =   1320
         Picture         =   "frmFactory_Stm.frx":08BF
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   2790
         Width           =   345
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFactory_Stm.frx":0D01
      Height          =   2730
      Left            =   135
      TabIndex        =   26
      Top             =   3780
   ...
   End
End
Attribute VB_Name = "frmFactory_Stm"
...
Private Sub Prod_Code()
       On Error Resume Next
        ...
        str = "SELECT DISTINCT Prod_Code FROM Godown_Master"
        rs.Open str, conn
        rs.MoveFirst
...
On Error Resume Next
        cmbProd_Name.Clear
        Set rs = New ADODB.Recordset
        str = "SELECT DISTINCT Prod_Name FROM Godown_Master"
        rs.Open str, conn
        rs.MoveFirst
...
On Error Resume Next
        ...
        str = "SELECT DISTINCT Prod_Model FROM Godown_Master"
        rsN.Open str, conn
        rsN.MoveFirst
...
Set rsN = New ADODB.Recordset
        str = "SELECT * FROM Godown_Master where Prod_Name Like '" & cmbProd_Name.Text & "' AND Prod_Model Like '" & cmbProd_Model.Text & "' order by Prod_code"
        rsN.Open str, conn
...
Prod = cmbProd_Name.Text
        ...
        cmbProd_Model.Clear
        Set rsN = New ADODB.Recordset
        str = "SELECT DISTINCT Prod_Model FROM Godown_Master where Prod_Name Like '" & Prod & "'"
        rsN.Open str, conn
        If Not rsN.EOF Then
...
If cmbType.Text = "All" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') order by Sl"
...
If cmbType.Text = "Purchase" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Purchase > 0 order by Sl"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptPurchase.rsIssue.ConnectionString = cnStr
                rptPurchase.rsIssue.Source = str
                rptPurchase.Label11.Caption = "UTILITIES PURCHASE REPORT"
...
If cmbType.Text = "Sale" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and sale > 0 order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptPurchase.rsIssue.ConnectionString = cnStr
                rptPurchase.rsIssue.Source = str
...
If cmbType.Text = "Issue" Then
        Set rs = New ADODB.Recordset
            str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Lift > 0 order by Sl"
            rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
        If Not rs.EOF Then
...
If cmbType.Text = "Return" Then
        Set rs = New ADODB.Recordset
            str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Return > 0 order by Sl"
            rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
        If Not rs.EOF Then
            rptIssue.rsIssue.ConnectionString = cnStr
            rptIssue.rsIssue.Source = str
...
If optSummary.Value = True Then
    ...
    If cmbType.Text = "All" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptProd_Statement.rsProd_Statement.ConnectionString = cnStr
                rptProd_Statement.rsProd_Statement.Source = str
    ...
    If cmbType.Text = "Purchase" Then
        Set rs = New ADODB.Recordset
            str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Purchase > 0 order by Prod_Code"
            rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
        If Not rs.EOF Then
    ...
    If cmbType.Text = "Issue" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Lift > 0 order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptProd_Summary.rsIssue.ConnectionString = cnStr
                rptProd_Summary.rsIssue.Source = str
    ...
    If cmbType.Text = "Return" Then
            Set rs = New ADODB.Recordset
                str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Return > 0 order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptProd_Summary.rsIssue.ConnectionString = cnStr
                rptProd_Summary.rsIssue.Source = str
...
If optProduct.Value = True Then
    ...
    Today = txtTo.Text
     ...
     Set rs = New ADODB.Recordset
        str = "select * from Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "')and Prod_Code like '" & txtId.Text & "' order by Sl"
        rs.Open str, conn
...
If optAll.Value = True Then
    ...
    If cmbType.Text = "Sale" Then
                Set rs = New ADODB.Recordset
                    str = "select * From Godown_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "')and sale > 0 order by Sl"
                    rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
                If Not rs.EOF Then
                    Adodc1.ConnectionString = cnStr
                    Adodc1.RecordSource = str
...
Private Sub txtId_LostFocus()
    ...
    Set rsN = New ADODB.Recordset
        str = "SELECT * FROM Godown_Master where Prod_Code Like '" & Prod & "'order by Prod_code"
        rsN.Open str, conn
