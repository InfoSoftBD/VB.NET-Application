VERSION 5.00
Begin VB.Form frmOld_due 
   BackColor       =   &H00004080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Old Due Posting"
   ClientHeight    =   7035
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8205
   Icon            =   "frm_Olddue.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7035
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_Olddue.frx":0442
         Left            =   210
         List            =   "frm_Olddue.frx":044C
         TabIndex        =   8
         Text            =   "Combo1"
         Top             =   3060
         Width           =   2055
...
Set rsN = New ADODB.Recordset
    ...
    Set rs = New ADODB.Recordset
        ...
        rs.MoveFirst
        rs!Cash_Dr = rs!Cash_Dr + Val(txtTotal.Text)
...
'MsgBox "Denomination Amount differs from Net Amount" & Val(txtTotal.Text) - Val(txtCash.Text), vbCritical, "Sale Info!"
'txtTotal.SetFocus
...
If Not rs.EOF Then
    If cmbType.Text = "Sales Due" Then
        rs!Sales_Due = rs!Sales_Due + Val(txtTotal.Text)
    ...
    Set rsU = New ADODB.Recordset
        str = "select * from GL_Master where AC_No like '" & 100155 & "'"
        rsU.Open str, conn, adOpenDynamic, adLockOptimistic
