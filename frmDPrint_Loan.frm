...
Begin VB.Form frmDPrint_Loan 
   BackColor       =   &H00008000&
   Caption         =   "Daily Loan Account Statement"
   ClientHeight    =   6930
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6540
   Icon            =   "frmDPrint_Loan.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6930
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmDPrint_Loan.frx":0442
         Height          =   1920
         Left            =   135
         TabIndex        =   27
         Top             =   135
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.OptionButton optTransaction 
         BackColor       =   &H00C0FFC0&
         Caption         =   "Daily Transection Report"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmDPrint_Loan"
...
Private Sub ComboPTerm()
        ...
        rs.Close
        End If
        cmbP_Term.AddItem "Close Account"
        cmbP_Term.AddItem "Ziro Balance"
End Sub
...
Set rs = New ADODB.Recordset
        ...
        str = "select * FROM Loan_Master where C_lose like '" & cl & "' order by Sl_No"
        rptLoan_Collection.Label11.Caption = "DAILY LOAN PERIODIC REPORT ALL"
        Else
            If cmbP_Term.Text = "Close Account" Then
            str = "select * FROM Loan_Master where C_lose like '" & Cls & "' order by Sl_No"
            rptLoan_Collection.Label11.Caption = "CLOSE ACCOUNTS REPORT"
            Else
                If cmbP_Term.Text = "Ziro Balance" Then
                str = "select * FROM Loan_Master where Amount like '" & 0 & "' order by Sl_No"
                rptLoan_Collection.Label11.Caption = "ZIRO BALANCE REPORT"
                Else
                str = "select * FROM Loan_Master where Term like '" & PTerm & "' order by Sl_No"
                rptLoan_Collection.Label11.Caption = "DAILY LOAN PERIODIC REPORT TERM WISE"
                End If
            End If
         End If
...
Set rsN = New ADODB.Recordset
    ...
    If Not rs.EOF Then
        ...
        rptLoan_Collection.rsLoan.Source = str
         ...
         rptLoan_Collection.PBalance.DataField = "Daily_Bal"
         rptLoan_Collection.Payment.DataField = "Daily_Pay"
         rptLoan_Collection.Due.DataField = "Due"
         rptLoan_Collection.NBalance.DataField = "Balance"
         
         rptLoan_Collection.PBalance_Total.DataField = "Daily_Bal"
         rptLoan_Collection.Payment_Total.DataField = "Daily_Pay"
         rptLoan_Collection.Withdraw_Total.DataField = "Due"
         rptLoan_Collection.Nbalance_Total.DataField = "Balance"
...
Set rs = New ADODB.Recordset
        ...
        str = "select * FROM Loan_Master where Daily_Pay > 0 order by Sl_No"
        rptLoan_Collection.Label11.Caption = "DAILY LOAN TRANSACTION REPORT ALL"
        Else
        str = "select * FROM Loan_Master where Term like '" & DTerm & "' and Daily_Pay > 0 order by Sl_No"
        rptLoan_Collection.Label11.Caption = "DAILY LOAN TRANSACTION REPORT TERM WISE"
        End If
        rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
...
Set rs = New ADODB.Recordset
    If cmbTerm.Text = "All" Then
        str = "select * FROM Loan_Master where FO_Code like '" & FO & "' AND Samity_Code like '" & Samity & "' AND Daily_Pay > 0 order by Sl_No"
        rptFO_Loan.Label11.Caption = "F.O. WISE DAILY LOAN TRANSACTION REPORT ALL"
    Else
        str = "select * FROM Loan_Master where FO_Code like '" & FO & "' AND Samity_Code like '" & Samity & "' AND Term like '" & Trm & "' AND Daily_Pay > 0 order by Sl_No"
        rptFO_Loan.Label11.Caption = "F.O. WISE DAILY LOAN TRANSACTION REPORT TERM WISE"
    End If
        rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
    If Not rs.EOF Then
...
Set rsN = New ADODB.Recordset
    ...
    If Not rs.EOF Then
        ...
        rptFO_Loan.rsFO_Loan.Source = str
         ...
         rptFO_Loan.rsFO_Loan.PBalance.DataField = "Daily_Bal"
         rptFO_Loan.rsFO_Loan.Payment.DataField = "Daily_Pay"
         rptFO_Loan.rsFO_Loan.Due.DataField = "Due"
         rptFO_Loan.rsFO_Loan.NBalance.DataField = "Balance"
         
         rptFO_Loan.rsFO_Loan.PBalance_Total.DataField = "Daily_Bal"
         rptFO_Loan.rsFO_Loan.Payment_Total.DataField = "Daily_Pay"
         rptFO_Loan.rsFO_Loan.Withdraw_Total.DataField = "Due"
         rptFO_Loan.rsFO_Loan.Nbalance_Total.DataField = "Balance"
