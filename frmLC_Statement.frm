...
Begin VB.Form frmLC_Statement 
   BackColor       =   &H00004080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "LC Statement"
   ClientHeight    =   6615
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7770
   Icon            =   "frmLC_Statement.frx":0000
   LinkTopic       =   "frmLCStatement"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6615
   ScaleWidth      =   7770
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmLC_Statement.frx":0442
         Left            =   2295
         List            =   "frmLC_Statement.frx":0458
         TabIndex        =   10
         Top             =   817
         Width           =   1845
      End
      Begin VB.CommandButton Command5 
         Height          =   375
         Left            =   4800
         Picture         =   "frmLC_Statement.frx":048C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   2790
         Width           =   345
      ...
      Begin VB.CommandButton Command4 
         Height          =   375
         Left            =   1320
         Picture         =   "frmLC_Statement.frx":08CE
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   2790
         Width           =   345
      ...
      Begin VB.ComboBox cmbAgent_Code 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmLC_Statement.frx":0D10
         Left            =   4230
         List            =   "frmLC_Statement.frx":0D26
         TabIndex        =   3
         Top             =   817
         Width           =   1170
      End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmLC_Statement.frx":0D5B
      Height          =   2730
      Left            =   135
      TabIndex        =   28
      Top             =   3780
   ...
   End
End
Attribute VB_Name = "frmLC_Statement"
...
Set rsN = New ADODB.Recordset
        str = "SELECT * FROM LC_Tran where Prod_Name Like '" & cmbProd_Name.Text & "' AND Prod_Model Like '" & cmbProd_Model.Text & "' order by Prod_code"
        rsN.Open str, conn
...
Prod = cmbProd_Name.Text
        ...
        cmbProd_Model.Clear
        Set rsN = New ADODB.Recordset
        str = "SELECT DISTINCT Prod_Model FROM LC_Tran where Prod_Name Like '" & Prod & "'"
        rsN.Open str, conn
        If Not rsN.EOF Then
...
If KeyAscii = 13 Then
If cmbType.Text = "Issue" Or cmbType.Text = "Purchase" Then
'Label4.Visible = True
...
If cmbType.Text = "All" Then
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') order by Sl"
...
If cmbType.Text = "Purchase" Then
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Qty > 0 order by Sl"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptLC.rsIssue.ConnectionString = cnStr
                rptLC.rsIssue.Source = str
                rptLC.Label11.Caption = "LETTER OF CREDIT REGISTRAR"
                rptLC.Field19.DataField = "Qty"
                rptLC.Field16.DataField = "Prod_Price"
                rs.Close
            Else
                MsgBox "There is no such Product found, ", vbCritical + vbOKOnly
                rs.Close
...
If cmbType.Text = "Purchase" Then
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Qty > 0 order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptLC.rsIssue.ConnectionString = cnStr
                rptLC.rsIssue.Source = str
                rptLC.Label11.Caption = "PRODUCT PURCHASES REPORT"
...
If cmbType.Text = "Agent Sale" Then
    If cmbAgent_Code.Text = "" Then
        ...
        Else
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Qty > 0 and Ref_no like '" & cmbAgent_Code.Text & "' order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptLC.rsIssue.ConnectionString = cnStr
                rptLC.rsIssue.Source = str
...
If cmbType.Text = "Issue" Then
        Set rs = New ADODB.Recordset
            str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Lift > 0 order by Sl"
            rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
        If Not rs.EOF Then
...
If cmbType.Text = "Purchase" Then
        ...
        If Not rs.EOF Then
            rptIssue.rsIssue.ConnectionString = cnStr
            rptIssue.rsIssue.Source = str
            rptIssue.Label11.Caption = "LETTER OF CREDIT REGISTRAR"
...
If optSummary.Value = True Then
    ...
    If cmbType.Text = "All" Then
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptProd_Statement.rsProd_Statement.ConnectionString = cnStr
                rptProd_Statement.rsProd_Statement.Source = str
    ...
    If cmbType.Text = "Purchase" Then
        ...
        If Not rs.EOF Then
            ...
            rptProd_Summary.Field31.DataField = "Qty"
    ...
    If cmbType.Text = "Purchase" Then
        ...
        If Not rs.EOF Then
            ...
            rptProd_Summary.lblFrom.Caption = txtFrom.Text
            rptProd_Summary.lblTo.Caption = txtTo.Text
            rptProd_Summary.Label11.Caption = "PRODUCT PURCHASES SUMMARY REPORT"
            rptProd_Summary.Field31.DataField = "Qty"
            'rptProd_Summary.Field30.DataField = "Prod_Price"
            rs.Close
        Else
            MsgBox "There is no such Product found, ", vbCritical + vbOKOnly
            rs.Close
    ...
    If cmbType.Text = "Issue" Then
            Set rs = New ADODB.Recordset
                str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Lift > 0 order by Prod_Code"
                rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
            If Not rs.EOF Then
                rptProd_Summary.rsIssue.ConnectionString = cnStr
                rptProd_Summary.rsIssue.Source = str
...
If optProduct.Value = True Then
    ...
    Today = txtTo.Text
     ...
     Set rs = New ADODB.Recordset
        str = "select * from LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "')and Prod_Code like '" & txtId.Text & "' order by Sl"
        rs.Open str, conn
...
If optAll.Value = True Then
    ...
    If cmbType.Text = "Agent Sale" Then
     If cmbAgent_Code.Text = "" Then
        ...
        Else
                Set rs = New ADODB.Recordset
                    str = "select * From LC_Tran where cdate(D_ate) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Qty > 0 and Ref_no like '" & cmbAgent_Code.Text & "' order by Sl"
                    rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
                If Not rs.EOF Then
                    Adodc1.ConnectionString = cnStr
                    Adodc1.RecordSource = str
