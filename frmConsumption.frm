...
Begin VB.Form frmConsumption 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image3 
         Height          =   2085
         Left            =   0
         Picture         =   "frmConsumption.frx":0442
         Stretch         =   -1  'True
         Top             =   0
         Width           =   11100
      End
...
On Error Resume Next
 Set rs = New ADODB.Recordset
    ...
    If Not rs.EOF Then
             rs!Purchase = rs!Purchase + Val(rsProd!Qty)
