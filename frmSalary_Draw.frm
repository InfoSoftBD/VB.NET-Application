...
Begin VB.Form frmSalary_Draw 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   735
      Left            =   120
      Picture         =   "frmSalary_Draw.frx":0442
      ScaleHeight     =   705
      ScaleWidth      =   7890
      TabIndex        =   55
      Top             =   120
      ...
      Begin VB.Image Image3 
         Height          =   735
         Left            =   0
         Picture         =   "frmSalary_Draw.frx":5CF0
         Stretch         =   -1  'True
         Top             =   0
         Width           =   7935
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmSalary_Draw.frx":FD7E
         Left            =   210
         List            =   "frmSalary_Draw.frx":FD88
         TabIndex        =   32
         Text            =   "Combo1"
         Top             =   3060
         Width           =   2055
   ...
   End
End
Attribute VB_Name = "frmSalary_Draw"
...
MsgBox "Denomination Amount differs from Net Amount" & Val(txtTotal.Text) - Val(txtCash.Text), vbCritical, "Due Info!"
