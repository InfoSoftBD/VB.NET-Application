...
Begin VB.Form frmVendor_Stm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command4 
         Height          =   375
         Left            =   1470
         Picture         =   "frmVendor_Stm.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1980
         Width           =   345
      ...
      Begin VB.CommandButton Command5 
         Height          =   375
         Left            =   4770
         Picture         =   "frmVendor_Stm.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   1980
         Width           =   345
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmVendor_Stm.frx":0CC6
      Height          =   2775
      Left            =   90
      TabIndex        =   9
      Top             =   3390
   ...
   End
End
Attribute VB_Name = "frmVendor_Stm"
...
Set rs = New ADODB.Recordset
        str = "select * from Vendor_Tran where cdate(Date) Between cdate('" & Fromdate & "') And cdate('" & Today & "') and Vendor_Code like '" & ID & "' order by Id"
        rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
        rs.MoveFirst

    rptVendor_Stm.rsStatement.ConnectionString = cnStr
    rptVendor_Stm.rsStatement.Source = str
...
Dim Today As Date
    ...
    If Not rs.EOF Then
        ...
        rs.Close
    Else
        MsgBox "There is no such Member Id found, ", vbCritical + vbOKOnly, "Merchandiser"
        rs.Close
    End If
    Exit Sub
    End Sub
...
Dim Today As Date
    ...
    If Not rs.EOF Then
        ...
        rs.Close
    Else
        MsgBox "There is no such Vendor Code found, ", vbCritical + vbOKOnly, "Merchandiser"
        rs.Close
    End If
    End If
    Exit Sub
...
Dim ID As String
    ...
    Set rs = New ADODB.Recordset
        str = "select * from Vendor_Tran where Vendor_Code like '" & ID & "'"
        rs.Open str, conn
