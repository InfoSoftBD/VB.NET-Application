...
Begin VB.Form frmRtprint 
   BackColor       =   &H00008000&
   Caption         =   "Weekly Report Print"
   ClientHeight    =   6975
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6645
   Icon            =   "frmRpt_Search.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6975
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmRpt_Search.frx":0442
         Height          =   1920
         Left            =   135
         TabIndex        =   27
         Top             =   135
...
Set rs = New ADODB.Recordset
        ...
        rptDSBTran.Label11.Caption = "WEEKLY SAVINGS PERIODIC REPORT ALL"
        Else
        str = "select * FROM Deposit_Master where Term like '" & PTerm & "' order by Sl_No"
        rptDSBTran.Label11.Caption = "WEEKLY SAVINGS PERIODIC REPORT ERM WISE"
        End If
...
Set rsN = New ADODB.Recordset
    ...
    Set rs = New ADODB.Recordset
    str = "select * FROM Deposit_Print order by Sl_No"
    rs.Open str, conn
        
    If Not rs.EOF Then
        rptDSBTran.rsTran.ConnectionString = cnStr
        rptDSBTran.rsTran.Source = str
         
         rptDSBTran.PBalance.DataField = "Weekly_Bal"
         rptDSBTran.Payment.DataField = "Weekly_Pay"
         rptDSBTran.Withdraw.DataField = "Weekly_Draw"
         rptDSBTran.NBalance.DataField = "Amount"
         
         rptDSBTran.PBalance_Total.DataField = "Weekly_Bal"
         rptDSBTran.Payment_Total.DataField = "Weekly_Pay"
         rptDSBTran.Withdraw_Total.DataField = "Weekly_Draw"
         rptDSBTran.Nbalance_Total.DataField = "Amount"
...
Set rs = New ADODB.Recordset
        ...
        str = "select * FROM Deposit_Master where Weekly_Pay > 0 or Weekly_Draw > 0 order by Sl_No"
        rptDSBTran.Label11.Caption = "WEEKLY SAVINGS TRANSACTION REPORT ALL"
        Else
        str = "select * FROM Deposit_Master where Term like '" & DTerm & "' and (Weekly_Pay > 0 or Weekly_Draw > 0)  order by Sl_No"
        rptDSBTran.Label11.Caption = "WEEKLY SAVINGS TRANSACTION REPORT TERM WISE"
        End If
        rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
    If Not rs.EOF Then
...
Set rs = New ADODB.Recordset
    If cmbTerm.Text = "All" Then
        str = "select * FROM Deposit_Master where FO_Code like '" & FO & "' AND Samity_Code like '" & Samity & "' AND Weekly_Pay > 0 or Weekly_Draw > 0 order by Sl_No"
        rptFO.Label11.Caption = "F.O. WISE WEEKLY SAVINGS TRANSACTION REPORT ALL"
    Else
        str = "select * FROM Deposit_Master where FO_Code like '" & FO & "' AND Samity_Code like '" & Samity & "' AND Term like '" & Trm & "' AND Weekly_Pay > 0 or Weekly_Draw > 0 order by Sl_No"
        rptFO.Label11.Caption = "F.O. WISE WEEKLY SAVINGS TRANSACTION REPORT TERM WISE"
    End If
        rs.Open str, conn, adOpenForwardOnly, adLockReadOnly
    If Not rs.EOF Then
...
Set rsN = New ADODB.Recordset
    ...
    If Not rs.EOF Then
        rptFO.rsFO.ConnectionString = cnStr
        rptFO.rsFO.Source = str
        
        rptFO.PBalance.DataField = "Weekly_Bal"
        rptFO.Payment.DataField = "Weekly_Pay"
        rptFO.Withdraw.DataField = "Weekly_Draw"
        rptFO.NBalance.DataField = "Amount"
        
        rptFO.PBalance_Total.DataField = "Weekly_Bal"
        rptFO.Payment_Total.DataField = "Weekly_Pay"
        rptFO.Withdraw_Total.DataField = "Weekly_Draw"
        rptFO.Nbalance_Total.DataField = "Amount"
