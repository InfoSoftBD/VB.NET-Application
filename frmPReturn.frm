...
Begin VB.Form frmPReturn 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Label Label2 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "PRODUCT PURCHASE RETURN"
         BeginProperty Font 
            Name            =   "Cooper Black"
            Size            =   24
            Charset         =   0
...
Dim Tran As String
    ...
    Set rs = New ADODB.Recordset
        str = "select * from Invo_Prev where Invo_No like '" & Tran & "'"
        ...
        If Not rs.EOF Then
            ...
            rptInvoice.lblTitle.Caption = "PURCHASE RETURN"
