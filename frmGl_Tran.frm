...
Begin VB.Form frmGL_Tran 
   BackColor       =   &H00004080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "GL Transaction Listing"
   ClientHeight    =   5520
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7200
   Icon            =   "frmGl_Tran.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5520
...
str = "select * from GL_Tran where cdate(Date) Between cdate('" & Fromdate & "') And cdate('" & toDate & "') order by Name"
...
If ProgressBar1.Value = ProgressBar1.Max Then
    ...
    rptJournal_Summary.lblFrom.Caption = txtFrom.Text
    rptJournal_Summary.lblTo.Caption = txtTo.Text
...
Dim toDate As Date
    ...
    Set rs = New ADODB.Recordset
        str = "select * from GL_Tran where cdate(Date) Between cdate('" & Fromdate & "') And cdate('" & toDate & "')"
        rs.Open str, conn
